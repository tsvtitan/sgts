...
6. sgts_oracle_01.08.2007.exe (новый релиз + данные за весь период)
...
достаточно места. Необходимо 2 Gb.
...
5. Установить новый релиз из файла: sgts_oracle_01.08.2007.exe


Установка длится около 10-12 часов.
