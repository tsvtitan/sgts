...
uses
  Classes, Controls, Grids, Graphics {$IFDEF VER150} , Types {$ENDIF}, Windows,
  Messages, Forms, StdCtrls, ELControls, SysUtils, Dialogs, TypInfo, Variants,
  ComCtrls, Menus, ELSConsts
