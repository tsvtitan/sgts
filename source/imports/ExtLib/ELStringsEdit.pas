...
var
  SELStringsEditorDlgCaption: string              = 'Редактор строк';
  SELStringsEditorDlgOkBtnCaption: string         = '&ОК';
  SELStringsEditorDlgCancelBtnCaption: string     = 'Отмена';
  SELStringsEditorDlgLinesCountTemplate: string   = '%d линий';
