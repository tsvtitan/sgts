...
type
  ...
  public
    ...
    function Checking(AVisible: Boolean=true): Boolean;
...
function TSgtsCheckingIface.Checking(AVisible: Boolean=true): Boolean;
begin
  Result:=CheckInBase;
  if AVisible and not Result then begin
    Init;
