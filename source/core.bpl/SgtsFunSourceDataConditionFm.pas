...
begin
  ...
  FIsCheckDef:=FSelectDefs.AddDrawCheck('IS_CHECK_EX','Выбрано','IS_CHECK',30,true);
  FSelectDefs.Find('IS_CHECK').Field:=FDataSet.FieldByName('IS_CHECK');
  FParamNameDef:=FSelectDefs.Add('PARAM_NAME','Параметр',150);
  FInstrumentNameDef:=FSelectDefs.Add('INSTRUMENT_NAME','Прибор',130);
  FMeasureUnitNameDef:=FSelectDefs.Add('MEASURE_UNIT_NAME','Единица измерения',50);
  FDefaultValueDef:=FSelectDefs.Add('DEFAULT_VALUE','Значение по умолчанию',50);
