...
type
  ...
  { properties }
    ...
    property RecalcJournalObservationsForm: ISgtsChildForm read _GetRecalcJournalObservationsForm;
    ...
    property RbkDefectViewsForm: ISgtsDataForm read _GetRbkDefectViewsForm;
    property RbkCriteriasForm: ISgtsDataForm read _GetRbkCriteriasForm;
