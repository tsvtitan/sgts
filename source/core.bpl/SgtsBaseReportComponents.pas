...
initialization
  ...
  frxResources.Add('propFetchCount','По сколько записей запрашивать с сервера. Значение -1 все записи');
...
//  frxResources.Add('propParams','па');
  frxResources.Add('propOpenMode','Режим получения записей. omOpen - получение в результате выборки. omExecute - получения в результате выполнения процедуры');
