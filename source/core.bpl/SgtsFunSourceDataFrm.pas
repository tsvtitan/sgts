...
begin
  if Assigned(Grid) then
    if Assigned(TSgtsFunSourceDbGrid(Grid).SelectedField) then
      Alignment:=TSgtsFunSourceDbGrid(Grid).SelectedField.Alignment;
