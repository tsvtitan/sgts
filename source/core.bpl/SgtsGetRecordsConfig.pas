...
function TSgtsGetRecordsConfigParams.Add(const ParamName: string; Value: Variant; IsNull: Boolean; Unique: Boolean): TSgtsGetRecordsConfigParam;
begin
  Result:=TSgtsGetRecordsConfigParam(inherited Add(ParamName,Value,IsNull,Unique));
end;
