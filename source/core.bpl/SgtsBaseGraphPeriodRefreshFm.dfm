inherited SgtsBaseGraphPeriodRefreshForm: TSgtsBaseGraphPeriodRefreshForm
      ...
      object GroupBoxHistory: TGroupBox
        ...
        object PanelListBoxHistory: TPanel
          ...
          object PanelButtonsHistory: TPanel
            ...
            object ButtonHistoryDelete: TButton
              Left = 5
              Top = 26
              Width = 21
              Height = 21
              ...
              ShowHint = True
              TabOrder = 1
              OnClick = ButtonHistoryDeleteClick
            end
          end
  ...
  object PopupMenuHistory: TPopupMenu
    ...
    Left = 219
    Top = 163
    object MenuItemHistoryAdd: TMenuItem
      Caption = #1044#1086#1073#1072#1074#1080#1090#1100
      Default = True
      Hint = #1044#1086#1073#1072#1074#1080#1090#1100' '#1080#1089#1090#1086#1088#1080#1102
      OnClick = MenuItemHistoryAddClick
    end
    object MenuItemHistoryChange: TMenuItem
      Caption = #1047#1072#1084#1077#1085#1080#1090#1100
      Hint = #1047#1072#1084#1077#1085#1080#1090#1100' '#1080#1089#1090#1086#1088#1080#1102
      OnClick = MenuItemHistoryChangeClick
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object MenuItemHistoryDelete: TMenuItem
      Caption = #1059#1076#1072#1083#1080#1090#1100
      Hint = #1059#1076#1072#1083#1080#1090#1100' '#1074#1099#1076#1077#1083#1077#1085#1085#1099#1077' '#1080#1089#1090#1086#1088#1080#1080
      OnClick = MenuItemHistoryDeleteClick
    end
    object MenuItemHistoryClear: TMenuItem
      Caption = #1054#1095#1080#1089#1090#1080#1090#1100
      Hint = #1054#1095#1080#1089#1090#1080#1090#1100' '#1080#1089#1090#1086#1088#1080#1102
      OnClick = MenuItemHistoryClearClick
    end
  end
end
