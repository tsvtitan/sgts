  ...
  begin
    ...
    if FDataSetParams.Active and
      ...
      with FDataSet do begin
        ...
        FSelectDefs.Add('CONVERTER_NAME','Преобразователь',50);
        ...
        while not FDataSetParams.Eof do begin            
          ...
          if (ParamType in [ptIntroduced]) and not VarIsNull(FilterInstrumentId) then begin
            ...
            FSelectDefs.Add(GetFieldByCounter('INSTRUMENT_NAME',Counter),'Прибор',70);
            ...
            FSelectDefs.Add(GetFieldByCounter('MEASURE_UNIT_NAME',Counter),'Единица измерения',30);
          end;
        ...
        FSelectDefs.AddDrawRadio('IS_BASE_EX','Базовый','IS_BASE',30,true);
  ...
  if CanRefresh then begin
    ...
    try
      ...
      if CreateData then begin
        ...
        FGrid.Hint:='Исходные данные: '+MeasureTypeName+'  (основное представление)';
