...
type
  TSgtsOpenMode=TSgtsGetRecordsConfigOpenMode;
  ...
  private
    ...
    function GetParams: TSgtsGetRecordsConfigParams;
  protected
  ...
  public
    ...
    property Params: TSgtsGetRecordsConfigParams read GetParams;
...
function TSgtsDatabaseCDS.GetParams: TSgtsGetRecordsConfigParams;
begin
  Result:=FGetRecordsConfig.Params;
end;
            ...
            with Current.Database do begin
              if Connected then begin
                ...
                try
                  ...
                  FGetRecordsConfig.CheckProvider:=FCheckProvider;
                  FGetRecordsConfig.OpenMode:=FOpenMode;
  ...
  with FExecuteConfig.Params do begin
    for i:=0 to Count-1 do begin
      ...
      if Param.ParamType in [ptOutput,ptInputOutput] then begin
        Def:=FExecuteDefs.Find(Param.ParamName);
        if Assigned(Def) then begin
