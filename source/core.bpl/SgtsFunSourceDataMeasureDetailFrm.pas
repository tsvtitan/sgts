  ...
  begin
    ...
    if FDataSetParams.Active and
      ...
      with FDataSetValues do begin
        ...
        FSelectDefsValues.Add('PARAM_NAME','Параметр',160);
        ...
        FSelectDefsValues.Add('INSTRUMENT_NAME','Прибор',100);
        ...
        FSelectDefsValues.Add('MEASURE_UNIT_NAME','Единица измерения',50);
        ...
        FSelectDefsValues.Add('VALUE','Значение',100);
  ...
  if CanRefresh then begin
    ...
    try
      ...
      if CreateData then begin
        ...
        FGrid.Hint:='Исходные данные: '+MeasureTypeName+'  (детальное представление)';
