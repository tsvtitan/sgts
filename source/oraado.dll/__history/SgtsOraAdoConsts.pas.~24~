...
resourcestring
  SInvalidUserNameOrPassword='Неверный пользователь или пароль.';

  SConnectionParamDataSource='DATA_SOURCE';
  SConnectionParamUserName='USER_NAME';
  SConnectionParamPassword='PASSWORD';

  SConnectionParamDataSourceDesc='База данных СГТС';
  SConnectionParamUserNameDesc='Пользователь БД (Администратор)';
  SConnectionParamPasswordDesc='Пароль пользователя БД';
  ...
  SFieldJournalCheckupId='JOURNAL_CHECKUP_ID';
  SFieldDocCheckupId='DOC_CHECKUP_ID';
  SFieldCriteriaId='CRITERIA_ID';
  ...
  SProviderAliasSelectCriterias='S_CRITERIAS';
  ...
  SProviderAliasInsertDocCheckup='DOC_CHECKUPS';
  SProviderAliasInsertCriteria='CRITERIAS';
