/* Создание функции расчета критерия приведенного напора в основании плотины. Створные пьезометры. Секция №32 */

CREATE OR REPLACE FUNCTION CRITERIA_PRESSURE_32 
( 
...
BEGIN 
  SELECT FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE,  
    ...
    INTO FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE,  
         FIRST_MODULO, SECOND_MODULO  
 FROM CRITERIAS  
   WHERE CRITERIA_ID=CRITERIA_PRESSURE_32.CRITERIA_ID; 
