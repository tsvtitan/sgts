/* Создание функции расчета критерия абсолютного горизонтального перемещения гребня. Секция №22 */
	
CREATE OR REPLACE FUNCTION CRITERIA_ABS_SHIFT_22 
( 
...
BEGIN 
  SELECT FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE,  
    ...
    INTO FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE,  
         FIRST_MODULO, SECOND_MODULO  
 FROM CRITERIAS  
   WHERE CRITERIA_ID=CRITERIA_ABS_SHIFT_22.CRITERIA_ID; 
