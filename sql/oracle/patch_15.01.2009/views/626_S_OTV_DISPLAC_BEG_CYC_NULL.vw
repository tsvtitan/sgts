/* Создание просмотра начального смещения отвесов с нулевого цикла */

CREATE OR REPLACE VIEW S_OTV_DISPLAC_BEG_CYC_NULL
AS 
