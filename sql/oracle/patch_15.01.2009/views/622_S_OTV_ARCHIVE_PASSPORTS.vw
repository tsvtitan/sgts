/* Создание просмотра архива паспортов отвесов */

CREATE OR REPLACE VIEW S_OTV_ARCHIVE_PASSPORTS
AS 
SELECT   MT.MEASURE_TYPE_ID,
         ...
         CP7.VALUE AS OT_X_DO,
         CP8.VALUE AS SM_X_DO,
         CP9.VALUE AS OT_Y_DO,
         CP10.VALUE AS SM_Y_DO
    FROM CONVERTERS C,
         POINTS P,
         ROUTE_POINTS RP,
         ROUTES R,
