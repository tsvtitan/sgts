/* Создание просмотра отчета по температуре 8 ГА напряженно-деформированного состояния вместе с гидрометеорологией */

CREATE OR REPLACE VIEW S_NDS_REPOTR_TEMP_8GA_GMO
AS 
SELECT R8.CYCLE_ID,
       R8.CYCLE_NUM,
       R8.DATE_OBSERVATION,
       R8.COORDINATE_Z,
       R8.VALUE_TEMPERATURE,
       R8.POINT_NAME,
       GMO.UVB,
       GMO.T_AIR,
       R8.TYPE,
