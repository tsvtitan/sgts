/* Создание просмотра объектов маршрутов */

CREATE OR REPLACE VIEW S_ROUTE_OBJECTS
AS 
SELECT RP.ROUTE_ID, R.NAME AS ROUTE_NAME, RP.POINT_ID, P.NAME AS POINT_NAME, P.OBJECT_ID, O.NAME AS OBJECT_NAME, OT.OBJECT_PATHS
 ...
 WHERE RP.ROUTE_ID = R.ROUTE_ID AND RP.POINT_ID = P.POINT_ID AND P.OBJECT_ID = O.OBJECT_ID AND O.OBJECT_ID = OT.OBJECT_ID(+)
