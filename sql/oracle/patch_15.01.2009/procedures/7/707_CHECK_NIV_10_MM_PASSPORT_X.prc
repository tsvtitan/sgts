/* Создание процедуры контроля CHECK_NIV_10_MM_PASSPORT_X */

CREATE OR REPLACE PROCEDURE CHECK_NIV_10_MM_PASSPORT_X
( 
...
AS 
  AVALUE FLOAT; 
BEGIN 
  SELECT COORDINATE_X INTO AVALUE 
  FROM POINTS 
  WHERE POINT_ID=CHECK_NIV_10_MM_PASSPORT_X.POINT_ID; 
