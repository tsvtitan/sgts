...
CREATE OR REPLACE VIEW S_OTV_CRITERION_VALUES_SEC_37
AS 
SELECT   'Абсолютные горизонтальные перемещения гребня в сторону НБ. Система прямых и обратных отвесов секции №37' PARAM_NAME,
         45 K1,
         49 K2,
         'ПО-2 Плотина\Тело плотины\Секция 37\Столб 1\Отм. 248.00' POINT_NAME,
         JO.CYCLE_NUM,
         JO.DATE_OBSERVATION,
