/* Создание просмотра параметров, приборов и единиц доступных видам измерения */
...
AS
  SELECT MT.MEASURE_TYPE_ID,
    ...
    FROM MEASURE_TYPE_PARAMS MTP, MEASURE_TYPES MT, PARAMS P, 
         PARAM_INSTRUMENTS PI, INSTRUMENTS I,
         INSTRUMENT_UNITS IU, MEASURE_UNITS MU 
...
ORDER BY MTP.PRIORITY, PI.PRIORITY, IU.PRIORITY
