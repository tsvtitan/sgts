/* Создание функции расчета критерия приведенного напора в основании плотины. Береговые пьезометры */

CREATE OR REPLACE FUNCTION CRITERIA_PRESSURE_BANK
(
...
BEGIN
  SELECT FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE, 
    ...
    INTO FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE, 
         FIRST_MODULO, SECOND_MODULO 
	FROM CRITERIAS 
   WHERE CRITERIA_ID=CRITERIA_PRESSURE_BANK.CRITERIA_ID;
