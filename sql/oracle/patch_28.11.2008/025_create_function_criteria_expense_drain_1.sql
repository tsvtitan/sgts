/* Создание функции расчета критерия фильтрационного расхода через скважины дренажа 1-го ряда */

CREATE OR REPLACE FUNCTION CRITERIA_EXPENSE_DRAIN_1
(
...
AS
  ...
  AMEASURE_TYPE_ID INTEGER:=2581 /* Дренаж основания 1 ряда */;
...
BEGIN
  SELECT FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE, 
    ...
    INTO FIRST_MIN_VALUE, FIRST_MAX_VALUE, SECOND_MIN_VALUE, SECOND_MAX_VALUE, 
         FIRST_MODULO, SECOND_MODULO 
	FROM CRITERIAS 
   WHERE CRITERIA_ID=CRITERIA_EXPENSE_DRAIN_1.CRITERIA_ID;
