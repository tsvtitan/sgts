/* Создание процедуры установки значения по умолчанию для С-А по штангенциркулю напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_CA_COMPASSES
(
...
AS
BEGIN
  IF (VALUE_10 IS NULL) THEN
    VALUE_10:=0.0;
  END IF;
  CALCULATE_SLF_VALUES(DATE_OBSERVATION,POINT_ID,
					   ...
					   VALUE_22,VALUE_23,
					   VALUE_24,
					   VALUE_25,VALUE_27,VALUE_29,
					   VALUE_26,VALUE_28,VALUE_30);  
END;
