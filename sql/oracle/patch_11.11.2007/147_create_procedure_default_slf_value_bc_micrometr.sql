/* Создание процедуры установки значения по умолчанию для Б-С по микрометру напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_BC_MICROMETR
(
