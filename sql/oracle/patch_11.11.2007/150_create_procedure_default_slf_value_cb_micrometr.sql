/* Создание процедуры установки значения по умолчанию для С-Б по микрометру напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_CB_MICROMETR
(
