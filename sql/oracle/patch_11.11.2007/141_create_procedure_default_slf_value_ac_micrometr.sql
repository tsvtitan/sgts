/* Создание процедуры установки значения по умолчанию для А-С по микрометру напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_AC_MICROMETR
(
