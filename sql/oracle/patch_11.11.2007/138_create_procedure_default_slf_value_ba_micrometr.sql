/* Создание процедуры установки значения по умолчанию для Б-А по микрометру напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_BA_MICROMETR
(
