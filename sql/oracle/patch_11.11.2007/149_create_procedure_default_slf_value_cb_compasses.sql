/* Создание процедуры установки значения по умолчанию для С-Б по штангенциркулю напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_CB_COMPASSES
(
