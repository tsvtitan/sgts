/* Создание процедуры установки значения по умолчанию для Б-С по штангенциркулю напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_BC_COMPASSES
(
