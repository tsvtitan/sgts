/* Создание процедуры установки значения по умолчанию для А-Б по штангенциркулю напольного щелемера */

CREATE OR REPLACE PROCEDURE DEFAULT_SLF_VALUE_AB_COMPASSES
(
